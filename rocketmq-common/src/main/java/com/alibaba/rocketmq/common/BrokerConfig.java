...
public class BrokerConfig {
    ...
    private boolean openDlqTopicDetector = false;
    
	public boolean isOpenDlqTopicDetector() {
		return openDlqTopicDetector;
	}

	public void setOpenDlqTopicDetector(boolean openDlqTopicDetector) {
		this.openDlqTopicDetector = openDlqTopicDetector;
	}
