...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand processRequest(ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
        ...
        switch (request.getCode()) {
            ...
            case RequestCode.ECHO_MESSAGE:
            	return this.processEchoMessage(ctx, request);
            default:
    ...
    private RemotingCommand processEchoMessage(final ChannelHandlerContext ctx, final RemotingCommand request){
    	final RemotingCommand response = RemotingCommand.createResponseCommand(SendMessageResponseHeader.class);
    	final SendMessageResponseHeader responseHeader = (SendMessageResponseHeader) response.readCustomHeader();
    	response.setOpaque(request.getOpaque());
    	responseHeader.setMsgId("echoMsgId");
    	responseHeader.setQueueId(0);
    	responseHeader.setQueueOffset(0L);
    	response.setCode(ResponseCode.SUCCESS);
    	response.setRemark("echo success");
    	return response;
    }
