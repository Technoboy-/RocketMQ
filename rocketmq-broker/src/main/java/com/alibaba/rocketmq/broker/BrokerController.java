...
import com.alibaba.rocketmq.broker.dlq.DLQTopicDetector;
...
public class BrokerController {
    ...
    private DLQTopicDetector dlqTopicDetector;
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
        	if(this.brokerConfig.isOpenDlqTopicDetector()){
        		this.dlqTopicDetector = new DLQTopicDetector(this);
        	}
    ...
    public void registerProcessor() {
        ...
        this.remotingServer.registerProcessor(RequestCode.ECHO_MESSAGE, sendProcessor, this.sendMessageExecutor);
        this.fastRemotingServer.registerProcessor(RequestCode.SEND_MESSAGE, sendProcessor, this.sendMessageExecutor);
        this.fastRemotingServer.registerProcessor(RequestCode.SEND_MESSAGE_V2, sendProcessor, this.sendMessageExecutor);
        this.fastRemotingServer.registerProcessor(RequestCode.CONSUMER_SEND_MSG_BACK, sendProcessor, this.sendMessageExecutor);
        this.fastRemotingServer.registerProcessor(RequestCode.ECHO_MESSAGE, sendProcessor, this.sendMessageExecutor);
        /**
    ...
    public void shutdown() {
        ...
        if(this.dlqTopicDetector != null){
        	this.dlqTopicDetector.shutdown();
        }
    }
